            ...
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        txtRDiffTender1.Text = dt.Rows[0]["commission_amount"].ToString();

                        txtRDiffTender.Text = Convert.ToString(Math.Round(Convert.ToDouble(txtRDiffTender1.Text) * Convert.ToDouble(txtQNTL.Text),0));
                        ...
                        txtTDSApplicalbeAmount.Text = dt.Rows[0]["texable_amount"].ToString();
                        txtTDS_Amount.Text = dt.Rows[0]["TDSAmount"].ToString();
                        lblTDS_AC_Code.Text = dt.Rows[0]["tdsname"].ToString();
                        hdnftds.Value = dt.Rows[0]["ta"].ToString();

                        if (txtDONO.Text != string.Empty && txtDONO.Text != "0")
                        {
                            btnEdit.Enabled = false;
                            btnDelete.Enabled = false;
                        }
                        ...
                        if (lblTenderNo.Text != string.Empty && lblTenderNo.Text != "0")
                        {
                            btnEdit.Enabled = true;
