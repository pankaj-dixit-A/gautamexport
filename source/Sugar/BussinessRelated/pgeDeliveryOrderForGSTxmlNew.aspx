    ...
    <script type="text/javascript" language="javascript">
        ...
        document.addEventListener('keyup', function (event) {
            ...
            if (key === 'Escape' || key === 'Esc' || key === 27) {
                ...
                if (hdnfClosePopupValue == "txtPurcGstRate") {

                    document.getElementById("<%=txtPurcGstRate.ClientID %>").focus();
                          }
    ...
    <script type="text/javascript" language="javascript">
        ...
        function SelectSibling(e) {
            ...
            if (KeyCode == 40) {
                ...
                if (hdnfClosePopupValue == "txtPurcGstRate") {
                    document.getElementById("<%=txtPurcGstRate.ClientID %>").value = grid.rows[SelectedRowIndex + 1].cells[0].innerText;
                     document.getElementById("<%=lblPurcGstRateName.ClientID %>").innerText = grid.rows[SelectedRowIndex + 1].cells[1].innerText;
                     document.getElementById("<%=txtPurcGstRate.ClientID %>").focus();
                 }
                if (hdnfClosePopupValue == "txtMemoGSTRate") {
...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript" language="javascript">
        ...
        function psgstcode(e) {
            if (e.keyCode == 112) {
                debugger;
                e.preventDefault();
                $("#<%=pnlPopup.ClientID %>").show();
                $("#<%=btntxtPurcGstRate.ClientID %>").click();

            }
            if (e.keyCode == 9) {
                e.preventDefault();
                var unit = $("#<%=txtPurcGstRate.ClientID %>").val();

                unit = "0" + unit;
                $("#<%=txtPurcGstRate.ClientID %>").val(unit);
                __doPostBack("txtPurcGstRate", "TextChanged");
    ...
    <script type="text/javascript">
        ...
        function Validate() {
            ...
            //var txtPurcGstRate = $("#<%=txtPurcGstRate.ClientID %>").val() == "" ? 0 : $("#<%=txtPurcGstRate.ClientID %>").val();
         //   if ((txtPurcGstRate == "") || txtPurcGstRate == "0") {
             //   $("#<%=txtPurcGstRate.ClientID %>").focus();
          //      $("#loader").hide(); return false;
           // }
           ...
           // var txtPurcGstRate = $("#<%=txtPurcGstRate.ClientID %>").val();
        ...
        function pagevalidation() {
            ...
            try {
               // $("#<%=txtSALE_RATE.ClientID %>").attr("disabled", "true");
                ...
                PSGSTRate = '<%= Session["PSGSTRate"] %>';
                PSigstrate = '<%= Session["PSigstrate"] %>';
                PSsgstrate = '<%= Session["PSsgstrate"] %>';
                PScgstrate = '<%= Session["PScgstrate"] %>';
                ...
                if (DESP_TYPE == "DI" && (txtGETPASS_CODE == SELFAC || PDS == "P")) {
                    if (autopurchasebill == "Y") {
                        ...
                        if (CompanyStateCode == PaymentGst) {
                            ...
                            PS_CGSTAmount = Math.round(parseFloat(PS_amount * PScgstrate / 100));
                            PS_SGSTAmount = Math.round(parseFloat(PS_amount * PSsgstrate / 100));
                            PS_IGSTAmount = 0;
                            PSigstrate = 0;
                        }
                        else {
                            ...
                            PS_SGSTAmount = 0;
                            PSsgstrate = 0;
                            PS_IGSTAmount = Math.round(parseFloat(PS_amount * PSigstrate / 100));
                        }
                        ...
                        if (voucherlbl == "" || voucherlbl == "0") {
                            XML = XML + "<PurchaseHead doc_no='" + purcDoc_No + "' Tran_Type='PS' PURCNO='" + doDoc_No + "' doc_date='" + PUR_DATE + "' " +
                                                    ...
                                                    "NETQNTL='" + txtquantal + "' CGSTRate='" + PScgstrate + "' CGSTAmount='" + PS_CGSTAmount + "' SGSTRate='" + PSsgstrate + "' " +
                                                    "SGSTAmount='" + PS_SGSTAmount + "' IGSTRate='" + PSigstrate + "' IGSTAmount='" + PS_IGSTAmount + "' " +
                                                    "GstRateCode='" + txtPurcGstRate + "' Company_Code='" + Company_Code + "' Year_Code='" + Year_Code + "' Branch_Code='" + Branch_Code + "' Created_By='" + USER + "' " +
        ...
        if (RecordStatus == "Save") {
          ...
          "SalebilltoGstStateCode='" + txtSalebilltoGstStateCode + "' GstAmtOnMR='0.00' GstAmtOnSR='0.00' GstExlSR='0.00' GstExlMR='0.00' " +
           ...
           "va='" + va + "' carporate_ac='" + BillTo + "' ca='" + bt + "' mill_inv_date='" + MillInv_Date + "' mill_rcv='" + Inv_Chk + "' saleid='" + saleid + "' MillEwayBill='" + MillEwayBill + "' " +
            ...
            "' PurchaseRate='" + Purchase_Rate + "' SBNarration='" + SBNARRATION + "' Do_DATE='" + Do_DATE + "' Insured='" + Insured + "' Insurance='" + Insurance + "' SB_Other_Amount='" + SB_Other_Amount + "' ISEInvoice='" + ISEInvoice + "' PSGstRateCode='" + txtPurcGstRate + "'>";
           ...
           "SalebilltoGstStateCode='" + txtSalebilltoGstStateCode + "' GstAmtOnMR='0.00' GstAmtOnSR='0.00' GstExlSR='0.00' GstExlMR='0.00' " +
            ...
            "' SBNarration='" + SBNARRATION + "' Do_DATE='" + Do_DATE + "' Insured='" + Insured + "' Insurance='" + Insurance + "' SB_Other_Amount='" + SB_Other_Amount + "' ISEInvoice='" + ISEInvoice + "' PSGstRateCode='" + txtPurcGstRate + "'>";
        }
                        ...
                        <td colspan="2" align="left">
                            ...
                            <td colspan="3" align="left">
                                ...
                                <ajax1:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtPurchase_Date"
                                 ...
                                 Purchase  GST Code:
                                <asp:TextBox ID="txtPurcGstRate" runat="Server" CssClass="txt" TabIndex="8" Width="80px"
                                    onkeydown="psgstcode(event);" Style="text-align: right;" AutoPostBack="false" OnTextChanged="txtPurcGstRate_TextChanged"
                                    Height="24px"></asp:TextBox>
                                <asp:Button ID="btntxtPurcGstRate" runat="server" Text="..." OnClick="btntxtPurcGstRate_Click"
                                    CssClass="btnHelp" Height="24px" Width="20px" />
                                <asp:Label ID="lblPurcGstRateName" runat="server" CssClass="lblName"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 20%; border-bottom: 3px solid white;" colspan="6">
                               <asp:TextBox ID="txtTruck_NO" runat="Server" CssClass="txt" TabIndex="35" Width="140px"  MaxLength="10"
                                   ToolTip="seperate numbers by comma" Style="text-align: left; text-transform: uppercase;" AutoPostBack="false" OnTextChanged="txtTruck_NO_TextChanged" 
                                    Height="24px"></asp:TextBox>&nbsp; 
