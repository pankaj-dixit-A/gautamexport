...
public partial class Sugar_pgeDeliveryOrderForGSTxmlNew : System.Web.UI.Page
{
    ...
    string oldFrieght = "";
    string oldMemoAdv = "";
    string Purcgstratename = string.Empty;
    ...
    private void makeEmptyForm(string dAction)
    {
        try
        {
            if (dAction == "N")
            {
                ...
                txtPurcGstRate.Enabled = false;
                btntxtPurcGstRate.Enabled = false;
            ...
            if (dAction == "A")
            {
                ...
                lblPurcGstRateName.Text = string.Empty;
                ...
                txtPurcGstRate.Enabled = true;
                btntxtPurcGstRate.Enabled = true;
                lblPDSParty.Text = "";
                lblSB_No.Text = "0";
                txtGstRate.Text = "1";
                ...
                DataSet ds2 = clsDAL.SimpleQuery("select Doc_no,GST_Name,Rate,IGST,SGST,CGST from nt_1_gstratemaster where doc_no=" + txtPurcGstRate.Text + " and company_code=" + Session["Company_Code"].ToString() + "");
                if (ds2 != null)
                {
                    if (ds1.Tables[0].Rows.Count > 0)
                    {
                        Session["PSGSTRate"] = ds2.Tables[0].Rows[0]["Rate"].ToString();
                        Session["PSigstrate"] = ds2.Tables[0].Rows[0]["IGST"].ToString();
                        Session["PSsgstrate"] = ds2.Tables[0].Rows[0]["SGST"].ToString();
                        Session["PScgstrate"] = ds2.Tables[0].Rows[0]["CGST"].ToString();
                    }
                }
            ...
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        txtPurcGstRate.Text = dt.Rows[0]["PSGstRateCode"].ToString();
                        lblPurcGstRateName.Text = dt.Rows[0]["PSGST_Name"].ToString();
                        ...
                        DataSet ds2 = clsDAL.SimpleQuery("select Doc_no,GST_Name,Rate,IGST,SGST,CGST from nt_1_gstratemaster where doc_no=" + txtGstRate.Text + " and company_code=" + Session["Company_Code"].ToString() + "");
                        if (ds2 != null)
                        {
                            if (ds1.Tables[0].Rows.Count > 0)
                            {
    ...
    private string getDisplayQuery()
    {
        try
        {
            ...
            string mystring = "";
            mystring = " SELECT     dbo.nt_1_deliveryorder.tran_type, dbo.nt_1_deliveryorder.doc_no, dbo.nt_1_deliveryorder.desp_type, dbo.nt_1_deliveryorder.doc_date, CONVERT(varchar(10), dbo.nt_1_deliveryorder.doc_date, " +
                      " 103) AS doc_dateConverted, dbo.nt_1_deliveryorder.mill_code, dbo.nt_1_deliveryorder.grade, dbo.nt_1_deliveryorder.quantal, dbo.nt_1_deliveryorder.packing, dbo.nt_1_deliveryorder.bags,  " +
                      ...
                      " gstmstmill.State_Name AS gstmillstatename, gstmstsellbill.State_Name AS gststatesellbillname, gstmsttransport.State_Name AS gststatetransportname, nt_1_gstratemaster_1.GST_Name, " + 
                      ...
                      " qrymstitem_1.HSN AS HSN1, dbo.nt_1_deliveryorder.SB_Other_Amount, dbo.nt_1_deliveryorder.PSGstRateCode, PSGSTRateMaster.GST_Name AS PSGST_Name,  " +
                      " PSGSTRateMaster.Rate AS PSRate " +
                      " FROM         dbo.nt_1_gstratemaster AS PSGSTRateMaster RIGHT OUTER JOIN " +
                      " dbo.nt_1_deliveryorder ON PSGSTRateMaster.Company_Code = dbo.nt_1_deliveryorder.company_code AND PSGSTRateMaster.Doc_no = dbo.nt_1_deliveryorder.PSGstRateCode LEFT OUTER JOIN " +
                      " dbo.qrymstitem AS qrymstitem_1 ON dbo.nt_1_deliveryorder.ic1 = qrymstitem_1.systemid LEFT OUTER JOIN " +
                      ...
                      " dbo.nt_1_gstratemaster AS nt_1_gstratemaster_1 ON dbo.nt_1_deliveryorder.GstRateCode = nt_1_gstratemaster_1.Doc_no AND  " +
                      " dbo.nt_1_deliveryorder.company_code = nt_1_gstratemaster_1.Company_Code LEFT OUTER JOIN " +
    ...
    #region [txtPurcGstRate_TextChanged]
    protected void txtPurcGstRate_TextChanged(object sender, EventArgs e)
    {
        searchString = txtPurcGstRate.Text;
        strTextBox = "txtPurcGstRate";
        csCalculations();
    }
    #endregion

    #region [btntxtPurcGstRate_Click]
    protected void btntxtPurcGstRate_Click(object sender, EventArgs e)
    {
        try
        {
            pnlPopup.Style["display"] = "block";
            hdnfClosePopup.Value = "txtPurcGstRate";
            btnSearch_Click(sender, e);
        }
        catch
        {
                        ...
                        if (ds.Tables.Count > 0)
                        {
                            ...
                            if (dt.Rows.Count > 0)
                            {
                                ...
                                if (txtcarporateSale.Text == string.Empty || txtcarporateSale.Text == "0")
                                {
                                    ...
                                    txtPurcGstRate.Text = dt.Rows[0]["gstratecode"].ToString();
                                    if (txtPurcGstRate.Text == "0")
                                    {
                                        txtPurcGstRate.Text = "1";
                                        lblPurcGstRateName.Text = clsCommon.getString("Select GST_Name from " + tblPrefix + "GSTRateMaster where Doc_no=1");
                                    }
                                    else
                                    {
                                        lblPurcGstRateName.Text = dt.Rows[0]["gstratename"].ToString();
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (hdnfClosePopup.Value == "txtPurcGstRate")
            {
                //txtSearchText.Text = searchString;
                tdDate.Visible = false;
                lblPopupHead.Text = "--Select Purchase GST--";
    ...
    private void csCalculations()
    {
        ...
        try
        {
                        ...
                        if (lblitem_Name.Text != string.Empty && lblitem_Name.Text != "0")
                        {
                            ...
                            if (dsi != null)
                            {
                                if (dsi.Tables[0].Rows.Count > 0)
                                {
                                    ...
                                    txtPurcGstRate.Text = dsi.Tables[0].Rows[0]["Gst_Code"].ToString();
            ...
            if (strTextBox == "txtPurcGstRate")
            {
                string gstratename = "";
                if (txtPurcGstRate.Text != string.Empty)
                {
                    bool a = clsCommon.isStringIsNumeric(txtPurcGstRate.Text);
                    if (a == false)
                    {
                        btntxtPurcGstRate_Click(this, new EventArgs());
                    }
                    else
                    {
                        Purcgstratename = clsCommon.getString("select GST_Name from " + tblPrefix + "GSTRateMaster  where Doc_No=" + txtPurcGstRate.Text + "");
                        if (Purcgstratename != string.Empty && Purcgstratename != "0")
                        {
                            DataSet ds1 = clsDAL.SimpleQuery("select Doc_no,GST_Name,Rate,IGST,SGST,CGST from nt_1_gstratemaster where doc_no=" + txtPurcGstRate.Text + " and company_code=" + Session["Company_Code"].ToString() + "");
                            if (ds1 != null)
                            {
                                if (ds1.Tables[0].Rows.Count > 0)
                                {
                                    Session["PSGSTRate"] = ds1.Tables[0].Rows[0]["Rate"].ToString();
                                    Session["PSigstrate"] = ds1.Tables[0].Rows[0]["IGST"].ToString();
                                    Session["PSsgstrate"] = ds1.Tables[0].Rows[0]["SGST"].ToString();
                                    Session["PScgstrate"] = ds1.Tables[0].Rows[0]["CGST"].ToString();
                                }
                            }
                            lblPurcGstRateName.Text = Purcgstratename;
                        ...
                        {
                            txtPurcGstRate.Text = string.Empty;
                            lblPurcGstRateName.Text = Purcgstratename;
                            setFocusControl(txtPurcGstRate);
                        }
                    }
                }
                else
                {
                    lblPurcGstRateName.Text = "";
                    setFocusControl(txtPurcGstRate);
                }
                //  return;
            }
