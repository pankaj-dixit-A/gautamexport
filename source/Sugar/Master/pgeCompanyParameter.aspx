            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table width="100%" align="left" cellspacing="3px">
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 30%;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtIECCode" runat="Server" CssClass="txt" TabIndex="20" Width="150px"
                                Height="24px" Style="text-align: right;"  AutoPostBack="false"
                                OnTextChanged="txtIECCode_TextChanged"></asp:TextBox> 
                        </td>
                    ...
                    <td align="right" style="width: 20%;"> 
                     ...
                     <td align="right" style="width: 20%;"> 
                      TDS SALE Balance Limit:
                        ...
                        <td>
                            <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="btnHelp" Width="100px" TabIndex="50"
