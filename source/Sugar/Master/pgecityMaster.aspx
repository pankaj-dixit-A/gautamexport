    ...
    <script type="text/javascript" language="javascript">
        ...
        document.addEventListener('keyup', function (event) {
            ...
            if (key === 'Escape' || key === 'Esc' || key === 27) {
                ...
                if (hdnfClosePopupValue == "txtCountryCode") {
    ...
    <script type="text/javascript" language="javascript">
        ...
        function SelectSibling(e) {
            ...
            if (KeyCode == 40) {
                ...
                if (hdnfClosePopupValue == "txtCountryCode") {
                    document.getElementById("<%=txtCountryCode.ClientID %>").value = grid.rows[SelectedRowIndex + 1].cells[0].innerText;
                    document.getElementById("<%=lblCountryCodeName.ClientID %>").innerText = grid.rows[SelectedRowIndex + 1].cells[2].innerText;
                    document.getElementById("<%=txtCountryCode.ClientID %>").focus();
...
function CountryCode(e) {
    ...
    if (e.keyCode == 112) {
        ...
        e.preventDefault();
        $("#<%=pnlPopup.ClientID %>").show();
        $("#<%=btntxtCountryCode.ClientID %>").click();

    }
    if (e.keyCode == 9) {
        e.preventDefault();
        var unit = $("#<%=txtCountryCode.ClientID %>").val();

        unit = "0" + unit;
        $("#<%=txtCountryCode.ClientID %>").val(unit);
        __doPostBack("txtCountryCode", "TextChanged");
        ...
        <ContentTemplate>
                ...
                <tr>
                    <td align="center">
                        ...
                        <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btnHelp" Width="90px"
                            TabIndex="13" ValidationGroup="add" OnClick="btnDelete_Click" OnClientClick="Confirm()" Height="24px" />
                        &nbsp;
                        ...
                        &nbsp;
                         <asp:Button ID="btnBack" runat="server" Text="Back" CssClass="btnHelp" Width="90px"
                             TabIndex="15" ValidationGroup="save" Height="24px" OnClientClick="Back()" />
                    </td>
                </tr>
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table style="width: 80%;" align="center" cellpadding="5" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList runat="server" ID="drpState" CssClass="ddl" Width="400px" Height="24px"
                                ...
                                <asp:ListItem>OTHER THAN INDIA</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right">Country Code:
                        </td>
                        <td align="left">
                            <asp:TextBox ID="txtCountryCode" runat="Server" CssClass="txt" TabIndex="9" Width="80px"
                                Style="text-align: right;" AutoPostBack="false" OnTextChanged="txtCountryCode_TextChanged"
                                Height="24px" onkeydown="CountryCode(event);"></asp:TextBox>
                            <asp:Button ID="btntxtCountryCode" runat="server" Text="..." OnClick="btntxtCountryCode_Click"
                                CssClass="btnHelp" Height="24px" Width="20px" />
                            <asp:Label ID="lblCountryCodeName" runat="server" CssClass="lblName"></asp:Label>
                        </td>
                    </tr>
                </table>
            </asp:Panel>
