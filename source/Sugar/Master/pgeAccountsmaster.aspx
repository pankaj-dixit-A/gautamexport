...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript">
        ...
        function pagevalidation(aarystring) {
            ...
            var Plant_Name = $("#<%=txtplantName.ClientID %>").val() == "" ? 0 : $("#<%=txtplantName.ClientID %>").val();
            var Plant_Code = $("#<%=txtplantCode.ClientID %>").val() == "" ? 0 : $("#<%=txtplantCode.ClientID %>").val();
            ...
            var IECode = $("#<%=txtIE_Code.ClientID %>").val();
            ...
            XML = XML + "<AccountHead Ac_Code='" + Accode + "' Ac_Name_E='" + AC_NAME_E + "' Ac_Name_R='" + AC_NAME_R + "' Ac_type='" + AC_TYPE + "' " +
                "Ac_rate='" + AC_RATE + "' Address_E='" + ADDRESS_E + "' Address_R='" + ADDRESS_R + "' " +
                   ...
                   "Email_Id='" + EMAIL_ID + "' EMAIL_ID_CC='" + EMAIL_ID_CC + "' Other_Narration='" + OTHER_NARRATIOM + "' ECC_No='' " +
                    ...
                    "' Limit_By='" + Limit_By + "' Tan_no='" + TANNO + "' TDSApplicable='" + TDSApplicable + "' CustomerCode='" + customercode + "' Insurance='" + Insurance + "' Ie_Code='" + IECode + "' plantName='" + Plant_Name + "' plantCode='" + Plant_Code + "'>";
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table cellspacing="3">
                    ...
                    <tr>
                         <td align="left" style="width: 10%;">Plant Name:
                        </td>
                        <td align="left" style="width: 10%;">
                             <asp:TextBox ID="txtplantName" runat="Server" CssClass="txt" AutoPostBack="false"
                                Height="22px"  Style="text-align: left;"
                                TabIndex="3" Width="250px"></asp:TextBox>

                        </td>
                         <td align="left" style="width: 10%;">Plant Code:
                        </td>
                          <td align="left" style="width: 10%;">
                             <asp:TextBox ID="txtplantCode" runat="Server" CssClass="txt" AutoPostBack="false"
                                Height="22px"  Style="text-align: left;"
                                TabIndex="3" Width="250px"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 10%;">IE_Code:
                        </td>
                        <td align="left" style="width: 10%;">
                            <asp:TextBox ID="txtIE_Code" runat="Server" AutoPostBack="false" CssClass="txtUpper"
                                Height="22px" OnTextChanged="txtIE_Code_TextChanged" Style="text-align: left;"
                                TabIndex="33" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    </tr>
                </table>
