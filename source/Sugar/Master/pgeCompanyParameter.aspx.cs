...
public partial class Sugar_Master_pgeCompanyParameter : System.Web.UI.Page
{
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string IECCode = txtIECCode.Text != string.Empty ? Convert.ToString(txtIECCode.Text) : "0";
            ...
            if (checkyear == null || checkyear == string.Empty || checkyear == "0")
            {
                ...
                Head_Fields = Head_Fields + "IECCode";
                Head_Values = Head_Values + "'" + IECCode + "'";
                flag = 1;
            ...
            else
            {
                ...
                if (s != string.Empty)
                {
                    ...
                    Head_Update = Head_Update + "IECCode=";
                    Head_Update = Head_Update + "'" + IECCode + "'";
                    #endregion
                }
                flag = 2;
