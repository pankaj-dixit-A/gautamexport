...
public partial class pgeOther_Purchase : System.Web.UI.Page
{
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        int maxno = Convert.ToInt32(clsCommon.getString("select isnull(max(opid),0) as opid from nt_1_other_purchase  where Company_Code='" + Convert.ToInt32(Session["Company_Code"].ToString()) + "' and Year_Code=" + Convert.ToInt32(Session["year"].ToString()) ));
