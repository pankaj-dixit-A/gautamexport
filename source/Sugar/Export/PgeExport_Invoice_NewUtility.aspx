<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PgeExport_Invoice_NewUtility.aspx.cs" Inherits="Foundman_Outword_PgeExport_Invoice_NewUtility" %>
...
<style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function GetCustomers(pageIndex) {
            ...
            $.ajax({
                type: "POST",
                url: "../Export/PgeExport_Invoice_NewUtility.aspx/GetCustomers",
        ...
        function OnSuccess(response) {
            ...
            if (customers.length > 0) {
                $.each(customers, function () {
                    ...
                    $("td", row).eq(2).html($(this).find("Inv1").text());
                    $("td", row).eq(3).html($(this).find("Inv2").text());
                    $("td", row).eq(4).html($(this).find("Inv3").text());
                    $("td", row).eq(5).html($(this).find("Export_Qty").text());
            ...
            $('#gvCustomers').on('dblclick', 'tr', function () {
                ...
                if (row_index > 0) {
                    ...
                    if (isNaN(Doc_No)) {
                        ...
                        window.open('../Export/PgeExport_Invoice_New.aspx?Doc_No=' + Doc_No + '&Action=' + Action);
                    }
    ...
    <script type="text/javascript">
        function Accmaster() {
            ...
            var Action = 2;
            var Doc_No = "";
            window.open("../Export/PgeExport_Invoice_NewUtility.aspx", "_self")
            window.open('../Export/PgeExport_Invoice_New.aspx?Doc_No=' + Doc_No + '&Action=' + Action);
        }
    </script>
    <script type="text/javascript">
                ...
                <center>
                    ...
                    <asp:GridView ID="gvCustomers" runat="server" AutoGenerateColumns="false" PageSize="25"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderStyle-Width="50px" DataField="Doc_Date" HeaderText="Doc Date"
                                AccessibleHeaderText="center" />
                            <asp:BoundField HeaderStyle-Width="70px" DataField="Inv1" HeaderText="Inv1" />
                            <asp:BoundField HeaderStyle-Width="70px" DataField="Inv2" HeaderText="Inv2" />
                            <asp:BoundField HeaderStyle-Width="70px" DataField="Inv3" HeaderText="Inv3" />
                             <asp:BoundField HeaderStyle-Width="70px" DataField="Export_Qty" HeaderText="Export Qty" />
