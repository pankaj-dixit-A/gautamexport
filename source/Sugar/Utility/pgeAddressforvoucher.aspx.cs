...
public partial class Sugar_pgeAddressforvoucher : System.Web.UI.Page
{
    ...
    string ExportDelaration = string.Empty;
    #endregion
                ...
                if (isAuthenticate == "1" || User_Type == "A")
                {
                    ...
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            txtExportDelaration.Text = ds.Tables[0].Rows[0]["ExportDelaration"].ToString();
                        }
                    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ExportDelaration = txtExportDelaration.Text;
            string retValue = string.Empty;
            string strRev = string.Empty;
            ...
            if (s == "0")
            {
                ...
                Head_Fields = Head_Fields + "ExportDelaration";
                Head_Values = Head_Values + "'" + ExportDelaration + "'";
            ...
            else
            {
                ...
                if (s1 != string.Empty)
                {
                    ...
                    Head_Update = Head_Update + "'" + dbbackup + "',";
                    Head_Update = Head_Update + "ExportDelaration=";
                    Head_Update = Head_Update + "'" + ExportDelaration + "'";
                    #endregion
                }
                flag = 2;
