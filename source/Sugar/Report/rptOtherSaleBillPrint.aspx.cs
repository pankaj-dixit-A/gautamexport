...
public partial class Sugar_Report_rptOtherSaleBillPrint : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            rpt.Load(Server.MapPath("crySaleBill_Print_other.rpt"));
            ...
            crySaleBill_Print_other.ReportSource = rpt;
            ...
            crySaleBill_Print_other.RefreshReport();
        }
        catch (Exception)
        {
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.crySaleBill_Print_other.ReportSource = null;

        crySaleBill_Print_other.Dispose();
