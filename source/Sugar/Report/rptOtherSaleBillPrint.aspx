<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptOtherSaleBillPrint.aspx.cs" Inherits="Sugar_Report_rptOtherSaleBillPrint" %>
...
<body>
    <form id="form1" runat="server">
        <div id="printReady">
            ...
            <CR:CrystalReportViewer ID="crySaleBill_Print_other" runat="server" AutoDataBind="false" />
        </div>
