<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="pgeExport_GLedgerReport.aspx.cs" Inherits="Foundman_Report_pgeExport_GLedgerReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        function sp(accode, fromdt, todt, DrCr) {
            var tn;
            window.open('rptExport_Ledger.aspx?accode=' + accode + '&fromdt=' + fromdt + '&todt=' + todt + '&DrCr=' + DrCr);    //R=Redirected  O=Original
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <fieldset style="border-top: 1px dotted rgb(131, 127, 130); border-radius: 3px; width: 90%;
        ...
        <legend style="text-align: center;">
            <asp:Label ID="label1" runat="server" Text="  Export GLedger Report   " Font-Names="verdana"
    ...
    <table width="60%" align="center" cellspacing="10">
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:DropDownList runat="server" ID="drptrantype" Width="100px" CssClass="ddl" AutoPostBack="true"
                                    TabIndex="1" Height="24px" OnSelectedIndexChanged="drptrantype_SelectedIndexChanged">
                                </asp:DropDownList>
                            </td>
                        </tr>
                    </table>
        ...
        <tr>
            ...
            <td align="left">
                <asp:DropDownList ID="drpUnit" runat="server" CssClass="ddl" Width="100px" Height="25px"
                    AutoPostBack="false">
                    <asp:ListItem Text="Unit 1" Value="1"></asp:ListItem>
                    <asp:ListItem Text="Unit 2" Value="2"></asp:ListItem>
